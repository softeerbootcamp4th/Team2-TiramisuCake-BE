...
import com.softeer.backend.fo_domain.draw.test.lua.DrawRedisLuaTest;
...
public class DrawService {
    ...
    private final DrawDatabaseWithoutLockTest drawDatabaseWithoutLockTest;
    private final DrawRedisLuaTest drawRedisLuaTest;
    ...
    public DrawModalResponseDto participateDrawEvent(Integer userId) {
        ...
        // Lua Script를 이용한 redis 테스트
        return drawRedisLuaTest.participateDrawEvent(userId);
